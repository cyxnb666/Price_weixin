...
Page({
  ...
  toDetail(e) {
    const {planId, stallId,stallName,taskStatus,collectPriceId,categoryId} = e.currentTarget.dataset.item
    // wx.navigateTo({
    ...
    if(taskStatus == '0'){
      wx.navigateTo({
        ...
        wx.navigateTo({
          url: `/subPackage/salePlan/sall/priceSend/priceSend?planId=${planId}&stallId=${stallId}&stallName=${stallName}&collectPriceId=${collectPriceId}&taskStatus=${taskStatus}&delta=1&categoryId=${categoryId}`,
        })
    }
