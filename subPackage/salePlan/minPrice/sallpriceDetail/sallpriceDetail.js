...
Page({
  ...
  deleteCategory(data){
    ...
    largeRemoveCollectCategory(data.detail.params).then(res=>{
  ...
  getDetails() {
    ...
    getLargeCollectPrice(params).then((res) => {
      ...
      this.setData({
        ...
        "pricingDetail.priceType":res.stallType == 'SFRM' ? "FARMER_SALE_PRICE" : 'WITH_SALES_PRICE',
