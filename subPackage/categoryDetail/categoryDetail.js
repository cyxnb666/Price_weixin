...
Page({
    ...
    generateSpecsData(specssList) {
        ...
        if (specssList.wholeSpecsVos && specssList.wholeSpecsVos.length) {
            const bulkData = {
                ...this.data.bulkData,
                ...specssList.wholeSpecsVos[0]
            }
            this.setData({
                bulkData: bulkData,
                showWeight: true
        ...
        getOwnerCollectCategory(params).then((res) => {
            ...
            if (res.specss && res.specss.length > 0) {
              ...
              this.setData({
                ...
                //         if (index !== -1) {
                //             diameterData[index] = { ...diameterData[index], ...item };
                //         } else {
                ...
                //         if (index !== -1) {
                //             weightData[index] = { ...weightData[index], ...item };
                //         } else {
